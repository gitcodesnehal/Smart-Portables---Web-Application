...
public class Home extends HttpServlet {
  public void doGet(HttpServletRequest request,
    ...
    if(SmartPortablesSerializedDataStore.hm_speakers.size()==0)
    {
    ...
    out.println("<html>");
		...
		out.println("<body>");
			...
			out.println("<table id='complete-table' style='position:absolute;width:315px;'></table>");
			out.println("</div>");
			out.println("</div>");
			out.println("</body>");
	...
	if (fname == null)
			...
			out.println("<li class='' ><a href='TrendingServlet'>Trending</a></li>");
				...
				//Data analytics and Inventory links only accessible to StoreManager
				if(fname!=null && type.equals("StoreManager"))
			{
				out.println("<li class='' ><a href='DataAnalyticsServlet'>Data Analytics</a></li>");
					out.println("<li class='' ><a href='AddUpdateDeleteProduct'>Alter Product</a></li>");
				//out.println("</nav>");
				out.println("<nav>");
				out.println("<ul>");
				out.println("<li class='start selected' ><a href='StoreManagerReportChoice'>Inventory Report</a></li>");
				out.println("<li class='start selected' ><a href='StoreManagerReportChoiceSales'>Sales Report</a></li>");
				out.println("</ul>");
				out.println("</nav>");
	...
	out.println("<p>The Website gives users the ability to buy certain electronic devices such as mobile phones,laptops - collectively, the 'Product' subject to these Site Terms.</p>");
	...
	out.println("<p>Phones</p>");
	out.println("<p>Laptops</p>");
	out.println("<p>External Devices</p>");
	
	out.println("<h2>Accessories Available</h2>");
	out.println("<p>USB outlets</p>");
	out.println("<p>Bluetooth keyboard</p>");
	out.println("<p>Wireless Mouse</p>");
	out.println("<p>Phone case</p>");
	out.println("</article>");
		
	out.println("<article class='expanded'>");
    	out.println("<h2>Hot Deals For You</h2>");
