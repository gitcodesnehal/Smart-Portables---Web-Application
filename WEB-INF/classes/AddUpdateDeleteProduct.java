...
public class AddUpdateDeleteProduct extends HttpServlet {
  public void doGet(HttpServletRequest request,
	...
	out.println("<h3>Choose Any of the below you wish to do:</h3>");
	
	out.println("<form action='AddUpdateDeleteProductNavigation'>");
	out.println("<input type='radio' name='navigateto' value='addproduct' required/> Add Product");
	out.println("<br>");
	out.println("<br>");
	out.println("<input type='radio' name='navigateto' value='deleteproduct' required/> Delete Product");
	out.println("<br>");
	out.println("<br>");
	out.println("<input type='radio' name='navigateto' value='updateproduct' required/> Update Product");
	out.println("<br>");
	out.println("<br>");
