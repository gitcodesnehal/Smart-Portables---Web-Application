...
public class StoreManagerReportChoiceSales extends HttpServlet {
  public void doGet(HttpServletRequest request,
	...
	out.println("<h2>Select which of the below report you wish to fetch:</h2>");
	out.println("<form action='SalesReportServlet'>");
	out.println("<input type='radio' name='choice' value='productsold' checked> Number of Products sold<br>");
	out.println("<input type='radio' name='choice' value='barchart'> Bar Chart of Product Name and Sales of Products<br>");
	out.println("<input type='radio' name='choice' value='dailytransaction'> Total daily sales Transaction<br>");
	out.println("<br><br>");
