...
public class UpdateProductServlet extends HttpServlet {
  public void doGet(HttpServletRequest request,
	...
	out.println("<h3>Select Product to update:</h3>");
	
	out.println("<form action='UpdateProductMessage'>");
	ArrayList<String> allproducts=  MySQLDataStoreUtilities.getAllProductNames();
	out.println("<select name='producttoupdate'>");
	...
	out.println("<br>");
	out.println("<br>");
	out.println("Enter new price  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:");
	out.println("<input type='text' name='price' required/></td>");
	out.println("<br>");
	out.println("<br>");
	out.println("Enter new discount  &nbsp&nbsp:");
	out.println("<input type='text' name='discount' required/></td>");
	out.println("<br>");
	out.println("<br>");
	out.println("Enter new rebates  &nbsp&nbsp&nbsp&nbsp:");
