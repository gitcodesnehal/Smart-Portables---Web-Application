...
public class StoreManagerReportChoice extends HttpServlet {
  public void doGet(HttpServletRequest request,
	...
	out.println("<h2>Select an Inventory report you wish to fetch:</h2>");
	out.println("<form action='InventoryReportServlet'>");
	out.println("<input type='radio' name='choice' value='productwithquantity' checked>All Products with available Quantity<br>");
	out.println("<input type='radio' name='choice' value='barchart'>Bar Chart of Products and available Quantity<br>");
	out.println("<input type='radio' name='choice' value='productwithsale'>Products currently on Sale<br>");
	out.println("<input type='radio' name='choice' value='productwithrebate'>Products with Some Rebate<br>");
	out.println("<br><br>");
