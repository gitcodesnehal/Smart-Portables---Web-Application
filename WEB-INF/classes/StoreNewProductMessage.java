...
public class StoreNewProductMessage extends HttpServlet {
  public void doGet(HttpServletRequest request,
	...
	out.println("<h1>New Product added Successfully.!</h1>");
	out.println("<a href='InsertProductServlet'><h2>Click here to add new product again");
